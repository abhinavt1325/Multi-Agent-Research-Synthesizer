        ...
        <section className="grid gap-8 lg:grid-cols-[0.8fr_2fr]">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h2 className="mt-2 text-lg font-bold text-ink">Current Search</h2>
            </div>
            <dl className="space-y-4">
              {[
                ...
                <div key={item.label} className="rounded-2xl border border-line bg-canvas/50 p-4">
                  ...
                  <dd className={`mt-1 font-semibold text-ink ${item.large ? 'text-3xl tracking-tight' : 'text-sm'}`}>{item.value}</dd>
                </div>
              ))}
            </dl>
          </div>
        ...
        <section className="space-y-6">
          ...
          {results.length ? (
            ...
            <div className="rounded-[32px] border border-dashed border-line bg-panel p-16 text-center shadow-sm">
              ...
              <p className="text-xl font-bold text-ink">No papers results yet.</p>
